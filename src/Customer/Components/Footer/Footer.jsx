...
const Footer = () => {
  return (
    <footer className="mt-10">
      <div class="bg-gray-800 p-5 text-gray-400">
      ...
      <div class="bg-indigo-700 py-4 text-gray-100">
        <div class="container mx-auto px-4">
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 mx-4 w-full text-center sm:w-auto sm:text-left">
              Copyright © 2024 Ezy-Cart. All Rights Reserved.
            </div>
            <div class="mx-4 px-4 w-full text-center sm:w-auto sm:text-left">
              Made with ❤️ by MS and Team.
            </div>
          </div>
        </div>
      </div>
